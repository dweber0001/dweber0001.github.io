...
<section id="projects" class="projects-section">
 <br>
  ...
  <a href="https://yourdoctorsoffice2021.azurewebsites.net/" target="_blank" class="project-tile">
   <p style="color: black; font-weight: 400; font-size: 15px; line-height: 1.2; text-align: left; margin-bottom: 8px; padding 0 25px;">ASP.NET responsive mock doctor's office website</p>
<img class="project-image" src="/images/homepage.png" alt="project"/>
  ...
  <a href="http://dweber-microblog-app.herokuapp.com/" target="_blank" class="project-tile">
   <p style="color: black; font-weight: 400; font-size: 15px; line-height: 1.2; text-align: left; margin-bottom: 8px; padding 0 25px;">Python app uses MongoDB and Heroku-modified from Udemy course</p>
 <img class="project-image" src="/images/BlogApp.PNG" alt="project" />
  ...
  <a href="https://deniseweberdev.com/matchGame/" target="_blank" class="project-tile"> 
   <p style="color: black; font-weight: 400; font-size: 15px; line-height: 1.2; text-align: left; margin-bottom: 8px; padding 0 25px;">JavaScript responsive matching game displays modal final stats/time</p>
 ...
 <p class="project project-title">
      <span class="code">Picture Matching Game</span>
       ...
       <a href="https://deniseweberdev.com/Quizzer/" target="_blank" class="project-tile">
        <p style="color: black; font-weight: 400; font-size: 15px; line-height: 1.2; text-align: left; margin-bottom: 8px; padding 0 25px;">JavaScript responsive quiz displays correct/total questions.</p>
