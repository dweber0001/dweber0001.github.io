...
<span style="color:#f0e130; text-shadow: 1px 1px 2px black, 0 0 25px #a81c07, 0 0 5px #5d0f04; font-weight: 600; font-size: 23px; text-align: center;">My animated background is designed to simulate a sunrise and sunset!</span> 

<p style="margin-right: 10px; float: right;"><img src="images/sunset.png" alt="sunset picture" width="330" height="230" style="border-radius:30%; margin-right: 20px; float: left;"/> 
