...
## About Me
I am passionate about learning, technology, collaboration and taking on challenges. Please look around and view links to some of my work. My other interests are design, travel, photography, my faith, family, friends **...sunrises and sunsets!** 
<p style="margin-right: 10px; float: right;"><img src="images/sunset.png" alt="sunset picture" width="420" height="320" style="border-radius:50%; margin-right: 20px; float: left;"/> 
...
<span style="color:#007fff; font-weight: 600; font-size: 17px;">Inspired by sunrises & sunsets, I designed my changing background to simulate a sunrise & sunset :)</span> 
<br>
## My Work
