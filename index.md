...
<span style="color:#fdfd96; text-shadow: 1px 1px 2px black, 0 0 30px #0892d0, 0 0 6px dark blue; font-weight: 400; font-size: 23px; align: center;">My animated background is designed to simulate a sunrise and sunset!</span> 

<p style="margin-right: 10px; float: right;"><img src="images/sunset.png" alt="sunset picture" width="340" height="230" style="border-radius:50%; box-shadow: 5px 10px 18px #0892d0; margin-right: 20px; float: left;"/> 
