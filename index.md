...
<section id="projects" class="projects-section">
 <br>
  ...
  <a href="https://yourdoctorsoffice2021.azurewebsites.net/" target="_blank" class="project-tile">
   <p style="color: #535351; font-weight: 400; font-size: 15px; line-height: 1.2; text-align: center; margin: 0 20px 8px 20px;">ASP.NET responsive mock doctor's office website</p>
 ...
 <p class="project project-title">
      <span class="code">Picture Matching Game</span>
       ...
       <a href="https://deniseweberdev.com/Quizzer/" target="_blank" class="project-tile">
        <p style="color: #535351; font-weight: 400; font-size: 15px; line-height: 1.2; text-align: center; margin: 0 20px 8px 20px;">JavaScript responsive quiz displays correct/total questions.</p>
