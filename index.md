...
<p style="margin-right: 10px; float: right;"><img src="images/sunset.png" alt="sunset picture" width="350" height="230" style="border-radius:60%; box-shadow: 5px 8px 14px #7e4108; margin-bottom: 25px; margin-right: 20px; float: left;"/> 
