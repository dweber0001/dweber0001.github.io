...
<section id="projects" class="projects-section">
 <br>
  ...
  <a href="https://yourdoctorsoffice2021.azurewebsites.net/" target="_blank" class="project-tile">
   <p style="color: #960955; font-weight: 400; font-size: 18px; line-height: 1.2; text-align:center; margin: 20px 10px 8px 10px;">ASP.NET responsive mock doctor's office website</p>
<img class="project-image" src="/images/homepage.png" alt="project"/>
  ...
  <a href="http://dweber-microblog-app.herokuapp.com/" target="_blank" class="project-tile">
   <p style="color: #960955; font-weight: 400; font-size: 18px; line-height: 1.2; text-align: center; margin: 20px 10px 8px 10px;">Python/MongoDB/Heroku based on Udemy course</p>
 <img class="project-image" src="/images/BlogApp.PNG" alt="project" />
  ...
  <a href="https://deniseweberdev.com/matchGame/" target="_blank" class="project-tile"> 
   <p style="color: #960955; font-weight: 400; font-size: 18px; line-height: 1.2; text-align: center; margin: 20px 10px 8px 10px;">JavaScript responsive game displays modal stats</p>
 ...
 <p class="project project-title">
      <span class="code">Picture Match Game</span>
       ...
       <a href="https://deniseweberdev.com/Quizzer/" target="_blank" class="project-tile">
        <p style="color: #960955; font-weight: 400; font-size: 18px; line-height: 1.2; text-align: center; margin: 20px 10px 8px 10px;">JavaScript responsive quiz shows correct #/10</p>
