...
<span style="color:#f0e130; text-shadow: 1px 1px 2px black, 0 0 25px #b85358, 0 0 5px #7d4261; font-weight: 600; font-size: 25px; text-align: center;">Note: Animated background designed to simulate a sunrise and sunset!</span> 

<p style="margin-right: 10px; float: right;"><img src="images/sunset.png" alt="sunset picture" width="350" height="220" style="border-radius:20%; margin-right: 20px; float: left;"/> 
