...
## About Me
<p width="600"><img float="left" src="images/sunset.png" width="350" height="220" style="border-radius:50%" alt="picture of sunset"/>&nbsp;&nbsp;<span width="200" height="200" float="right">Note: I designed my color changing background to simulate a sunset :)</span></p>
